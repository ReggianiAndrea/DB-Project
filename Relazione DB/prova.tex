...
\subsection{Aggiunta linea evolutiva}
...
\subsection{Rimozione di pokemon dal pokedex} 
...
Entità coinvolte: POKÉMON, ESEMPLARE\_POKÉMON
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/schema_er.png} % TODO: togli il placeholder
\end{figure}
...
Questa operazione, eseguibile sia dall'Amministratore che dal Giocatore, permette di impostare lo stato di amicizia tra due allenatori. La selezione dello stato \textbf{Bloccato} impedirà qualsiasi interazione (es. Sfide in Battaglia) tra i due Giocatori fino ad una successiva selezione dello stato di \textbf{Sblocco}.
...
Entità coinvolte: POKÉMON, GIOCATORE, AVVISTAMENTO
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/schema_er.png} % TODO: togli il placeholder
\end{figure}
...
Entità coinvolte: POKÉMON, GIOCATORE, ESEMPLARE\_POKÉMON, SQUADRA, BOX\_POKÉMON
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/schema_er.png} % TODO: togli il placeholder
\end{figure}
...
Entità coinvolte: ESEMPLARE\_POKÉMON, SQUADRA, BOX\_POKÉMON, GIOCATORE

\subsection{Cercare pokemon che vivono in un determinato bioma}
...
\subsection{Cercare pokemon con un determinato tipo elementare}
...
\subsection{Cercare pokemon che si evolvono con un metodo evolutivo definito}
Il giocatore seleziona un metodo evolutivo (es. Pietrafocaia, Scambio) e visualizza le specie correnti, le specie evolute e i relativi dettagli per le evoluzioni innescate da tale metodo.

-Entità coinvolte: POKÉMON, EVOLUZIONE, METODO\_EVOLUTIVO, TRAMITE

\subsection{Visualizzare allenatori con pokemon shiny}
...
Entità coinvolte: ESEMPLARE\_POKÉMON, GIOCATORE, CUSTODIA

\subsection{Visualizzare i pokemon shiny di un determinato allenatore}
...
Entità coinvolte: ESEMPLARE\_POKÉMON, POKÉMON, GIOCATORE
...
Entità coinvolte: GIOCATORE, SQUADRA, ESEMPLARE\_POKÉMON, POKÉMON, COMPOSIZIONE
...
\begin{enumerate}
  ...
  \textbf{Totale:} 2L + 1S = 4 accessi => 1080 accessi/anno
  ...
  \textbf{Totale:} 4L + 2S = 8 accessi => 16 accessi/anno
  ...
  \textbf{Totale:} 100L = 100 accessi => 1200 accessi/anno \\
  ...
  \textbf{Totale:} 2L + 1S = 4 accessi => 7200 accessi/anno
  ...
  \textbf{Totale:} 2L + 1S = 4 accessi => 1440 accessi/anno
  ...
  \textbf{Totale:} 13L = 13 accessi => 4680 accessi/anno
  ...
  \textbf{Totale:} 716L = 716 accessi => 515520 accessi/anno
  ...
  \textbf{Totale:} 250L = 250 accessi => 12000 accessi/anno
  ...
  \textbf{Totale:} 765L = 765 accessi => 36720 accessi/anno
  ...
  \textbf{Totale:} 551L = 551 accessi => 28652 accessi/anno
  ...
  \textbf{Totale:} 698L = 698 accessi => 34296 accessi/anno
  ...
  \textbf{Totale:} 351L = 351 accessi => 252720 accessi/anno
  ...
  \textbf{Totale:} 250L = 250 accessi => 13000 accessi/anno
  ...
  \textbf{Totale:} 250L = 250 accessi => 3000 accessi/anno
  ...
  \textbf{Totale:} 1213L = 1213 accessi => 58224 accessi/anno
  ...
  \textbf{Totale:} 100001L = 100001 accessi => 10400104 accessi/anno
...
\begin{tabular}{|c|c|c|c|}
  ...
  \textbf{Totale:} 100L = 100 accessi => 10400 accessi/anno
  ...
  \textbf{Totale:} 310L = 310 accessi => 111600 accessi/anno
  ...
  \textbf{Totale:} 6030L = 6030 accessi => 1000980 accessi/anno
...
\begin{enumerate}
  ...
  \textbf{Totale:} 1107S = 2214 accessi => 2214 accessi/anno
...
4L + 2S = 8 accessi => 16 accessi/anno \\
\\
...
250L = 250 accessi => 3000 accessi/anno \\
\\
Consideriamo, quindi, il totale: \\
Senza ridondanza: 316208 accessi/anno \\
Con ridondanza: 3016 accessi/anno \\
\\
...
100L = 100 accessi => 1200 accessi/anno \\
