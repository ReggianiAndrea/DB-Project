...
\newpage
\section{Sviluppo dell'ambito evoluzione}
...
\section{Sviluppo dell'ambito Giocatore - Esemplare Pokémon}
...
\section{Sviluppo dell'ambito Pokémon}
...
\section{Sviluppo dell'ambito Specie ed Esemplare}
...
\section{Sviluppo dell'ambito Tipologia Elementale}
...
\section{Sviluppo dell'ambito Giocatore e Archiviazione}
...
\section{Sviluppo dell'ambito Battaglia e Squadra}
...
\begin{enumerate}
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
  \end{tabular} \\
  3L + 1S = 5 accessi => 10 accessi/anno
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
  \end{tabular} \\
  2L + 1S = 4 accessi => 896 accessi/anno
...
\begin{enumerate}
	...
	\begin{verbatim}
		SELECT g1.Nickname Sfidante, g2.Nickname Sfidato, b.Data, b.Luogo, b.SfidanteVincitore
