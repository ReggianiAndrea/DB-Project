...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/PokemonAndBioma.png}
\end{figure}
...
Entità coinvolte: POKÉMON, ESEMPLARE POKÉMON
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/schema_er.png} % TODO: togli il placeholder
\end{figure}
...
Entità coinvolte: POKÉMON, GIOCATORE, ESEMPLARE POKÉMON, SQUADRA, BOX POKÉMON
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/schema_er.png} % TODO: togli il placeholder
\end{figure}
...
Entità coinvolte: ESEMPLARE POKÉMON, SQUADRA, BOX POKÉMON, GIOCATORE
...
Entità coinvolte: POKÉMON, EVOLUZIONE, METODO EVOLUTIVO, TRAMITE
...
Entità coinvolte: ESEMPLARE POKÉMON, GIOCATORE, CUSTODIA
...
Entità coinvolte: ESEMPLARE POKÉMON, POKÉMON, GIOCATORE
...
Entità coinvolte: GIOCATORE, SQUADRA, ESEMPLARE POKÉMON, POKÉMON, COMPOSIZIONE
