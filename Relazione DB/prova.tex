...
Una mossa è un attacco che un Pokémon può effettuare in una battaglia, questa possiede un nome specifico che la identifica, una descrizione e un parametro molto importante, quale la \textit{precisione}. Quest'ultima indica la probabilità percentuale che una mossa centri il bersaglio, ma esistono mosse dove il bersaglio non può essere mancato, quindi che si dicono \textit{infallibili}.
Non tutte le mosse hanno come obiettivo quello di arrecare danno all'avversario, ma sono presenti anche mosse di \textit{Stato}.

Ogni Pokémon può imparare più mosse e la stessa mossa può essere imparata da più Pokémon. Ogni mossa ha un unico elemento a cui è collegata ma ad un elemento possono essere associate più mosse. Un Pokémon può avere una mossa di un elemento diverso dai suoi elementi caratteristici. Le mosse possono essere di tre tipologie:
\begin{itemize}
       \item Fisico
       \item Speciale
       \item Stato
...
Le mosse di tipo \textit{Fisico} sono mosse che richiedono al Pokémon uno sforzo fisico, queste possono danneggiare il bersaglio dell'attacco.
Le mosse di tipo \textit{Speciale} sono mosse che, rispetto a quelle fisiche, non richiedono uno sforzo fisico al Pokémon, bensì le sue capacità elementali.
Le mosse di tipo \textit{Stato} sono mosse che alterano lo stato del Pokémon, ovvero possono potenziare o depotenziare il bersaglio in base alle necessità; per bersaglio si può intendere anche il Pokémon stesso che esegue la mossa.

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/PokemonElementoMossa.png}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
    ...
    \caption{Schema di navigazione per cambiare il Pokémon preferito di un giocatore}
  \end{figure}  
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/EvoluzioneNavigazione.png}
    \caption{Schema di navigazione per visualizzare la linea evolutiva di un Pokémon}
  \end{figure}  
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/MetodoEvolutivoNavigazione.png}
    \caption{Schema di navigazione per visualizzare i Pokémon che si evolvono tramite un certo metodo evolutivo}
  \end{figure}    
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/BiomaElementoNavigazione.png}
    \caption{Schema di navigazione per visualizzare gli elementi di Pokémon che appartengono allo stesso bioma}
  \end{figure}  
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/StoricoBattaglieNavigazione.png}
    \caption{Schema di navigazione per visualizzare lo storico delle battglie dei giocatori}
  \end{figure}  
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{immagini/VisualizzaPokedex.png}
    \caption{Immagine dimostrativa del pannello Giocatore Visualizza Pokédex}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{immagini/VisualizzaAmici.png}
    \caption{Immagine dimostrativa del pannello Giocatore Visualizza Amici}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{immagini/GestisciSquadra.png}
    \caption{Immagine dimostrativa del pannello Giocatore Gestisci Squadra}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{immagini/Profilo.png}
