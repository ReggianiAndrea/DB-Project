...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/PokemonBasta?.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/PokemonRimozione.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/PokemonAvvistamentoGiocatore.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{immagini/EsemplarePokemonGiocatorePokemon.png}
\end{figure}
...
\hline
3 & Possibilità di cambiare il proprio Pokémon preferito & 2/Anno \\
\hline
4 & Possibilità di bloccare un amico & 3/Mese \\
\hline
5 & Possibilità di sbloccare un amico bloccato & 2/Mese \\
\hline
...
\hline
20 & Possibilità di visualizzare quali Pokémon cromatici possiede un allenatore & 2/Settimana \\
\hline
...
\begin{enumerate}
	...
	\item \textit{Possibilità di cambiare il proprio Pokémon preferito}
	\begin{verbatim}
		UPDATE GIOCATORE
	...
	\item \textit{Possibilità di bloccare un amico}
	\begin{verbatim}
		UPDATE AMICIZIA
		SET BLOCCATO = TRUE
	...
	\item \textit{Possibilità di sbloccare un amico bloccato}
	\begin{verbatim}
		UPDATE AMICIZIA
		SET BLOCCATO = FALSE
		WHERE IdGiocatore = giocatore1
	...
	\item \textit{Possibilità di visualizzare quali Pokémon cromatici possiede un allenatore}
	\begin{verbatim}
