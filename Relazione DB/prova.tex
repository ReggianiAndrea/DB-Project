...
\item Aggiunta di Pokémon al Pokédex (amministratori) 
\item Rimozione di Pokémon dal Pokédex (amministratori) 
\item Gestione delle relazioni di amicizia (amministratori)

\item Incontrare Pokémon e salvare l'avvistamento (giocatori)
\item Incontrare Pokémon e catturarli (giocatori)
\item Gestione Box e squadra giocatore (giocatori)

\item Cercare Pokémon che vivono in un determinato bioma (giocatori)
\item Cercare Pokémon con un determinato tipo elementare (giocatori)
\item Cercare Pokémon che si evolvono con un metodo evolutivo definito (giocatori)

\item Visualizzare allenatori con Pokémon cromatico (giocatori)
\item Visualizzare i Pokémon cromatico di un determinato allenatore (giocatori)
