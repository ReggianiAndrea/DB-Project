...
Le mosse di tipo \textbf{Fisico} sono mosse che richiedono al Pokémon uno sforzo fisico, queste possono danneggiare il bersaglio dell'attacco. 
Le mosse di tipo \textbf{Speciale} sono mosse che, rispetto a quelle fisiche, non richiedono uno sforzo fisico al Pokémon, bensì le sue capacità elementali. 
Le mosse di tipo \textbf{Stato} sono mosse che alterano lo stato del Pokémon, ovvero possono potenziare o depotenziare il bersaglio in base alle necessità; per bersaglio si può intendere anche il Pokémon stesso che esegue la mossa. 
